...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(PROJECT_HOME,'app.db'),                     # Or path to database file if using sqlite3.
...
MEDIA_ROOT = os.path.join(PROJECT_HOME,"uploads")
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(PROJECT_HOME, "aristotle", "static")
